...
(async()=>{
 ...
 await page.locator('[data-action="goto-slide"][data-page="15"]').click();assert.match(await page.locator('.slide-box img').getAttribute('alt'),/Attention/);
 ...
 await page.locator('#query').fill('phan bo xac suat');await page.locator('.card').first().click();await page.locator('[data-action="source"]').first().click();assert.equal(await page.locator('#page-number').inputValue(),'11');
